...
std::unique_ptr<Trike> TrikeFactory::create(unit_t unit) {
    switch (unit) {
        /*
        case HARVESTER:
    ...
    return std::make_unique<Trike>(0,0,Position(0,0),0,0,0,0); // REFACTOR: Handle this kind of stuff with an exception
}
