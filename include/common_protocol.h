...
class Protocol {
 ...
 public:
    ...
    void send_trike(int id, int faction, int lp, int pos_x, int pos_y,int direction, bool moving,bool selected, bool attacking, Socket& client_socket);
    ...
    void receive_trike(int& id, int& faction, int& lp, int& pos_x, int& pos_y, int& direction,bool& moving,bool& selected, bool& attacking, Socket& client_socket);
